...
# #Cluster Assignment Dicitonaries
# clus_genders = {}
# clus_race = {}
# clus_age = {}
...
#print("Cluster_Assignment_Details::::::::::::::::::::::::::::::::::::::::::::::::::::::: \n\n",clusterDetails, "\n")
	

#plt.scatter(df[0], df[1], c= labels.astype(float), s=50, alpha=0.5)#df[0] column 0, df[1] column 1
#plt.scatter(centroids[:, 0], centroids[:, 1], c='red', s=50)
#plt.show()

	# Data for a three-dimensional line
#plt.figure('K-Means on Race Demographics', figsize=(7,7))
...
##################################plotRaceClusters(df, labels, centroids)
...
# ax.scatter(centroids[:,0],centroids[:,1],centroids[:,2] ,c='r', s=200, label='centroid', alpha=1)
#######################
#######################hashtag_names_tuple = tuple(hashtag_names)
#######################White_tuple = tuple(df.iloc[:,0])
#######################Black_tuple = tuple(df.iloc[:,1]) 
#######################Asian_tuple = tuple(df.iloc[:,2]) 


# for h, x, y, z in zip(hashtag_names_tuple, Black_tuple, White_tuple, Asian_tuple):
# 	Label = '%s' % (h)
# 	ax.text(x, y, z, Label)
